...
const programData = [
  ...
  { time: '16:30 – 16:40', title: 'Иван', description: '«Есть ли предел развитию искусственного интеллекта?»' },
  { time: '16:40 – 16:50', title: 'Алибек', description: '«Как заменить рутину в бизнесе искусственным интеллектом»' },
  { time: '16:50 – 17:05', title: '3 выпускника ICAI', description: 'Презентации AI-проектов' },
  { time: '17:05 – 17:15', title: 'Перерыв + нетворкинг', description: 'Время для общения и обмена контактами' },
  { time: '17:15 – 18:15', title: 'Воркшоп', description: 'Создание AI-видео (ChatGPT, MidJourney, Kling)' },
  { time: '18:15 – 18:25', title: 'Мини-панель', description: '«Что дальше?»' },
  { time: '18:25 – 18:35', title: 'Розыгрыш призов', description: 'Подарки для участников' },
  { time: '18:35 – 18:45', title: 'Закрытие + общее фото', description: 'Завершение мероприятия и общее фото' },
]
