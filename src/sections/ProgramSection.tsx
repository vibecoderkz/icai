...
const programData = [
  ...
  { time: '16:10 – 16:25', title: 'Толкын', description: '«Data Science в нефтяной отрасли»' },
  { time: '16:25 – 16:40', title: 'Даурен', description: '«ИИ, переговоры и деньги: как выигрывать в строительстве в 2025»' },
  { time: '16:40 – 16:55', title: 'Иван', description: '«Есть ли предел развитию искусственного интеллекта?»' },
  { time: '16:55 – 17:10', title: '3 выпускника ICAI', description: 'Презентации AI-проектов' },
  { time: '17:10 – 17:20', title: 'Перерыв + нетворкинг', description: 'Время для общения и обмена контактами' },
  { time: '17:20 – 18:20', title: 'Воркшоп', description: 'Создание AI-видео (ChatGPT, MidJourney, Kling)' },
  { time: '18:20 – 18:30', title: 'Мини-панель', description: '«Что дальше?»' },
  { time: '18:30 – 18:40', title: 'Розыгрыш призов', description: 'Подарки для участников' },
  { time: '18:40 – 19:00', title: 'Закрытие + общее фото', description: 'Завершение мероприятия и общее фото' },
]
